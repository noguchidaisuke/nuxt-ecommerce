<template>
  <div>
    <!-- Drawer -->
    <v-navigation-drawer app v-model="drawer" clippek dark>
      <v-container>
        <v-list-item>
    ...
    <v-app-bar app clipped-left dark>
      ...
      <form novalidate="novalidate" onsubmit="return false;" class="searchbox sbx-amazon">
        <div role="search" class="sbx-amazon__wrapper">
          <input type="search" name="search" placeholder="Search your website" autocomplete="off" required="required" class="sbx-amazon__input" style="color: black">
      ...
      <v-btn outlined>Get Started</v-btn>
    </v-app-bar>
    <v-content>
      <router-view />
    </v-content>
...
export default {
  data() {
    return {
      drawer: false,
      nav_lists: [
        {name: 'Cart', icon: 'mdi-cart-outline'},
        {name: 'Address', icon: 'mdi-home-map-marker'},
        {name: 'Profile', icon: 'mdi-square-edit-outline'},
      ],
      items: [
